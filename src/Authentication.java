...
public static String ObtenerToken()
{
	...
	String respuestaLogin =	
		RestAssured.given().with()
		.headers("Cookie","fpc=AtqSCVehDsxPuEZu98aYmZaGIV0qAQAAAHjDedoOAAAA; stsservicecookie=estsfd; x-ms-gateway-slice=estsfd")
		 .headers("Accept","*/*")
       ...
       .formParam("scope", "api://7e467100-fb19-4d21-908a-80ca3096b546/.default")
		.post("/cef04b19-7776-4a94-b89b-375c77a8f936/oauth2/v2.0/token")
